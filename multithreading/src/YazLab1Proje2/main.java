...
public class main extends arayuz{

    static String listProduct[] = new String[100];
    static String listIssue[] = new String[100];
    static String listCompany[] = new String[100];
    static String listState[] = new String[100];
    static String listComplaintid[] = new String[100];
    static String listZipcode[] = new String[100];
